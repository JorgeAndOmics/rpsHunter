...
def parse_rpsbproc_output(
    ...
    Parses all RPSBPROC output files in the input directory and writes tabular results to disk.
        ...
        ----------
            ...
            :param output_csv_name: Output CSV filename (optional). Defaults to 'domains.csv'.
            :param output_parquet_name: Output Parquet filename (optional). Defaults to 'domains.parquet'.

        Returns
        -------
            :returns: None. Writes results to the specified CSV and Parquet files.
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='Parse RPSBPROC output files into structured CSV and Parquet tables.'
    )
    ...
    parse_rpsbproc_output(
        ...
        output_parquet_name=args.output_parquet
    )
